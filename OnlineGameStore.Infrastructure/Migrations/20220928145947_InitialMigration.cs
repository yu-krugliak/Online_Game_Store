    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GamePlatformType", x => new { x.GamesId, x.PlatformsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GamePlatformType_PlatformTypes_PlatformsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamePlatformType_PlatformsId",
